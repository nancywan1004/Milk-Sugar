                ...
                <div class="col-lg-8">
                    <form class="form-contact contact_form" method="POST" action="orderstatus.php" id="form1">
                        ...
                        <div class="form-group mt-3">
                            <button type="submit"  name="track" value="track" class="button button-block" form="form1">Submit</button>
                        </div>
                    </form>
                    ...
                    <section class="section-margin">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <form class="form-contact" action="orderstatus.php" id="form_id" method="post" name="myform">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <input class="form-control" name="confirm#" id="confirm#" type="text" placeholder="Enter Confirmation #">
